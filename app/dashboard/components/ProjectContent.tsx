const ProjectContent = () => {
	return (
		<div className='col-span-10 bg-dashboard-bg rounded-3xl h-full'>
			<h1 className='px-4 pb-3 pt-4 text-white text-xl font-adlam-display'>
				My Works
			</h1>
			...
			<div className='grid grid-cols-5 gap-4 px-4 pt-5 dashboard-content-height'>
